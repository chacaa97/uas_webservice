...
<div class="grid gap-4">
    <div>
        <img class="h-auto max-w-full border-radius 0" src="https://cdn.gramedia.com/uploads/marketing/Special_Offer_Buku-Buku_Rio_Johan_Storefront__wauto_h336.jpg" alt="">
    </div>
    <div class="grid grid-cols-5 gap-4">
        <div>
            <img class="h-auto max-w-full rounded-lg" src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//catalog-image/107/MTA-99165545/gramedia_buku_novel_-_xoxo_full01_sasb015r.jpeg" alt="">
        </div>
        <div>
            <img class="h-auto max-w-full rounded-lg" src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//91/MTA-41213449/brd-44261_original-off-the-record-3-buku-novel-indonesia_full01.jpg" alt="">
        </div>
        <div>
            <img class="h-auto max-w-full rounded-lg" src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//catalog-image/115/MTA-98852794/gramedia_buku_novel_-_vermilion_rain_full01_u10lnhp3.jpeg" alt="">
        </div>
        <div>
            <img class="h-auto max-w-full rounded-lg" src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//catalog-image/86/MTA-143321342/brd-07091_novel-gadis-kretek-ratih-kumala-cover-film-_full01-b009e17c.jpg" alt="">
        </div>
        <div>
            <img class="h-auto max-w-full rounded-lg" src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//catalog-image/90/MTA-134413146/brd-38904_novel-namaku-alam-jilid-1-leila-s-chudori-_full01-c0dc8abb.jpg" alt="">
        </div>
    </div>
</div>
<div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
      ...
      <div class="text-center">
        ...
        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">di Toko Buku</h1>
        <p class="mt-6 text-lg leading-8 text-gray-600">Temukan Buku Yang Kamu inginkan disini!</p>
        <div class="mt-10 flex items-center justify-center gap-x-6">
          <a href="/barang" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Cari Buku</a>
        </div>
      </div>
    </div>
